...
/***/ function(module, exports) {
	...
	var svOAuth2 = function svOAuth2() {
	    ...
	    this.$get = function ($http, svOAuthStorage, svQueryStringHelper, $q) {
	        ...
	        var getAccessCode = function getAccessCode(redirectUri) {
	            ...
	            window.location = config.baseUrl + '' + config.authorizePath + appendChar + 'response_type=code&' + 'client_id=' + encodeURIComponent(config.clientId) + '&' + 'redirect_uri=' + encodeURIComponent(usedRedirectUri) + '&' + 'scope=' + oAuthScope;
	        };
